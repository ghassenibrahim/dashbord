	...
	<link rel="stylesheet" href="<?php echo base_url() ?>assets/js/plugin/animate.css/animate.min.css">
	<link rel="stylesheet" href="<?php echo base_url() ?>assets/js/plugin/fontawesome/css/fontawesome-all.css">
	<link rel="stylesheet" href="<?php echo base_url() ?>assets/js/plugin/flag-icon-css/flag-icon.min.css"> 
